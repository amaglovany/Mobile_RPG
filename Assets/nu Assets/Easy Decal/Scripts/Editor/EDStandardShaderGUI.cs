...
namespace UnityEditor
{
    internal class EDStandardShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            this.m_WorkflowMode = this.specularMap == null || this.specularColor == null
                ? (this.metallicMap == null || this.metallic == null
                    ? EDStandardShaderGUI.WorkflowMode.Dielectric
                    : EDStandardShaderGUI.WorkflowMode.Metallic)
                : EDStandardShaderGUI.WorkflowMode.Specular;
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.normalMapText, this.bumpMap,
                !((UnityEngine.Object) this.bumpMap.textureValue != (UnityEngine.Object) null)
                    ? (MaterialProperty) null
                    : this.bumpScale);
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.heightMapText, this.heightMap,
                !((UnityEngine.Object) this.heightMap.textureValue != (UnityEngine.Object) null)
                    ? (MaterialProperty) null
                    : this.heigtMapScale);
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.occlusionText, this.occlusionMap,
                !((UnityEngine.Object) this.occlusionMap.textureValue != (UnityEngine.Object) null)
                    ? (MaterialProperty) null
            ...
            GUILayout.Label(EDStandardShaderGUI.Styles.secondaryMapsText, EditorStyles.boldLabel,
                new GUILayoutOption[0]);
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.detailAlbedoText,
                this.detailAlbedoMap);
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.detailNormalMapText,
                this.detailNormalMap, this.detailNormalMapScale);
        ...
        {
            if (ShaderGUI.FindProperty("_SpecGlossMap", props, false) != null &&
                ShaderGUI.FindProperty("_SpecColor", props, false) != null)
                this.m_WorkflowMode = EDStandardShaderGUI.WorkflowMode.Specular;
            else if (ShaderGUI.FindProperty("_MetallicGlossMap", props, false) != null &&
                     ShaderGUI.FindProperty("_Metallic", props, false) != null)
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
        {
            ...
            if ((UnityEngine.Object) oldShader == (UnityEngine.Object) null ||
                !oldShader.name.Contains("Legacy Shaders/"))
                return;
        ...
        private void BlendModePopup()
        {
            ...
            EditorGUI.BeginChangeCheck();
            EDStandardShaderGUI.BlendMode blendMode2 = (EDStandardShaderGUI.BlendMode) EditorGUILayout.Popup(
                EDStandardShaderGUI.Styles.renderingMode, (int) blendMode1, EDStandardShaderGUI.Styles.blendNames,
                new GUILayoutOption[0]);
            if (EditorGUI.EndChangeCheck())
            {
        ...
        private void DoGrungMaskArea(Material material)
        {
            ...
            this.m_MaterialEditor.ShaderProperty(this.grungeFactor, EDStandardShaderGUI.Styles.grungeFactorText.text,
                3);
        }

        private void DoAlbedoArea(Material material)
        {
            this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.albedoText, this.albedoMap,
                this.albedoColor);
        ...
        private void DoEmissionArea(Material material)
        {
            ...
            this.m_MaterialEditor.TexturePropertyWithHDRColor(EDStandardShaderGUI.Styles.emissionText, this.emissionMap,
                this.emissionColorForRendering, this.m_ColorPickerHDRConfig, false);
            if ((UnityEngine.Object) this.emissionMap.textureValue != (UnityEngine.Object) null && !flag3 &&
                (double) maxColorComponent <= 0.0)
                this.emissionColorForRendering.colorValue = Color.white;
            if (flag2)
            {
                EditorGUI.BeginDisabledGroup(
                    !EDStandardShaderGUI.ShouldEmissionBeEnabled(this.emissionColorForRendering.colorValue));
        ...
        private void DoSpecularMetallicArea()
        {
            if (this.m_WorkflowMode == EDStandardShaderGUI.WorkflowMode.Specular)
            {
                if ((UnityEngine.Object) this.specularMap.textureValue == (UnityEngine.Object) null)
                    this.m_MaterialEditor.TexturePropertyTwoLines(EDStandardShaderGUI.Styles.specularMapText,
                        this.specularMap, this.specularColor, EDStandardShaderGUI.Styles.smoothnessText,
                        this.smoothness);
                else
                    this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.specularMapText,
                        this.specularMap);
            }
            else
            {
                ...
                if ((UnityEngine.Object) this.metallicMap.textureValue == (UnityEngine.Object) null)
                    this.m_MaterialEditor.TexturePropertyTwoLines(EDStandardShaderGUI.Styles.metallicMapText,
                        this.metallicMap, this.metallic, EDStandardShaderGUI.Styles.smoothnessText, this.smoothness);
                else
                    this.m_MaterialEditor.TexturePropertySingleLine(EDStandardShaderGUI.Styles.metallicMapText,
                        this.metallicMap);
            }
        }
        ...
        {
            EDStandardShaderGUI.SetKeyword(material, "_NORMALMAP",
                (bool) ((UnityEngine.Object) material.GetTexture("_BumpMap")) ||
                (bool) ((UnityEngine.Object) material.GetTexture("_DetailNormalMap")));
            if (workflowMode == EDStandardShaderGUI.WorkflowMode.Specular)
                EDStandardShaderGUI.SetKeyword(material, "_SPECGLOSSMAP",
                    (bool) ((UnityEngine.Object) material.GetTexture("_SpecGlossMap")));
            else if (workflowMode == EDStandardShaderGUI.WorkflowMode.Metallic)
                EDStandardShaderGUI.SetKeyword(material, "_METALLICGLOSSMAP",
                    (bool) ((UnityEngine.Object) material.GetTexture("_MetallicGlossMap")));
            EDStandardShaderGUI.SetKeyword(material, "_PARALLAXMAP",
                (bool) ((UnityEngine.Object) material.GetTexture("_ParallaxMap")));
            EDStandardShaderGUI.SetKeyword(material, "_DETAIL_MULX2",
                (bool) ((UnityEngine.Object) material.GetTexture("_DetailAlbedoMap")) ||
                (bool) ((UnityEngine.Object) material.GetTexture("_DetailNormalMap")));
            ...
            if ((illuminationFlags1 & (MaterialGlobalIlluminationFlags.RealtimeEmissive |
                                       MaterialGlobalIlluminationFlags.BakedEmissive)) ==
                MaterialGlobalIlluminationFlags.None)
                return;
            MaterialGlobalIlluminationFlags illuminationFlags2 =
                illuminationFlags1 & ~MaterialGlobalIlluminationFlags.EmissiveIsBlack;
            if (!state)
        ...
        {
            EDStandardShaderGUI.SetupMaterialWithBlendMode(material,
                (EDStandardShaderGUI.BlendMode) material.GetFloat("_Mode"));
        ...
        private static class Styles
        {
            ...
            static Styles()
            {
                ...
                EDStandardShaderGUI.Styles.alphaCutoffText =
                    new GUIContent("Alpha Cutoff", "Threshold for alpha cutoff");
                EDStandardShaderGUI.Styles.specularMapText =
                    new GUIContent("Specular", "Specular (RGB) and Smoothness (A)");
                EDStandardShaderGUI.Styles.metallicMapText =
                ...
                EDStandardShaderGUI.Styles.detailMaskText =
                    new GUIContent("Detail Mask", "Mask for Secondary Maps (A)");
                EDStandardShaderGUI.Styles.detailAlbedoText =
                ...
                EDStandardShaderGUI.Styles.emissiveWarning = new GUIContent(
                ...
                EDStandardShaderGUI.Styles.emissiveColorWarning =
